/**
 * Shared audio helpers used by /api/tts and /api/tunnel.
 * Chunking keeps each model request small; concatWav stitches the
 * same-format WAV results back into a single playable file.
 */

export const TTS_VOICES = ['jam', 'kazi', 'xiaochen', 'tongtong', 'douji', 'luodo', 'chuichui'] as const;

export function splitIntoChunks(text: string, maxLength = 950): string[] {
